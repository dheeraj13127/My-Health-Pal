...
return (
  <div className="loginBack">
      <div className="container">
        <div  className="row">
          <div className="col s12 l4 offset-l2 push-l5 loginForm" style={{marginTop:"195px"}}>
            <a href="/" className="btn-flat waves-effect white-text">
            ...
            <div className="col s12" style={{ paddingLeft: "11.250px" }}>
              ...
              <p className="white-text text-darken-1">
                Don't have an account? <Link to="/register" className="black-text">Register</Link>
              </p>
            </div>
